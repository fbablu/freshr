    ...
    def seed_data():
        ...
        for i in range(10):
            for sensor in sensors:
                ...
                if (
                    scenario == "drift"
                    and sensor["sensor_type"] == "cold_storage_temperature"
                ):
                ...
                is_anomaly = (
                    sensor["sensor_type"] == "cold_storage_temperature" and value > 5
                ) or (sensor["sensor_type"] == "handwash_station_usage" and value == 0)
